          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-4 p-5 bg-slate-50 rounded-xl border border-slate-100">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@igfguatemala.org" className="text-sky-600 hover:underline text-sm">info@igfguatemala.org</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-5 bg-slate-50 rounded-xl border border-slate-100">
                    <div className="w-10 h-10 rounded-xl bg-sky-50 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={label} className="flex items-center gap-3 p-4 border border-slate-100 rounded-xl hover:border-sky-200 hover:shadow-sm transition-all group">
                      <div className="w-8 h-8 rounded-lg bg-sky-50 group-hover:bg-sky-100 flex items-center justify-center flex-shrink-0 transition-colors">
                        <Icon className="w-4 h-4 text-sky-600" />
                      </div>
                      <div>
                        <p className="font-semibold text-blue-950 text-xs">{label}</p>
              ...
              <div className="p-6 bg-gradient-to-br from-sky-50 to-blue-50 border border-sky-100 rounded-2xl">
                ...
                <a href="mailto:info@igfguatemala.org" className="inline-flex items-center gap-2 text-sky-600 font-semibold text-sm hover:text-blue-700 transition-colors">
                  Contáctanos
