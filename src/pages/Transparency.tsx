        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-bold text-green-950">Comité Organizador</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {committee.map(({ name, role, org, sector }) => (
                <div key={name} className="p-5 border border-slate-100 rounded-xl hover:border-emerald-200 hover:shadow-md transition-all">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 to-green-600 flex items-center justify-center text-white font-bold text-sm mb-4">
                    {name.split(' ').map(n => n[0]).join('')}
                  </div>
                  <h3 className="font-bold text-green-950">{name}</h3>
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-bold text-green-950">Criterios de Selección de Sesiones</h2>
            </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-bold text-green-950">Código de Conducta</h2>
            </div>
            <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-7">
              ...
              <a href="#" className="inline-flex items-center gap-2 text-emerald-600 font-semibold hover:text-green-700 transition-colors text-sm">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-bold text-green-950">Política de Patrocinio</h2>
            </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-bold text-green-950">Aliados y Apoyos</h2>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {allies.map(({ name, type }) => (
                <div key={name} className="p-5 border border-slate-100 rounded-xl text-center hover:border-emerald-200 hover:shadow-md transition-all">
                  <div className="w-12 h-12 rounded-full bg-emerald-50 flex items-center justify-center mx-auto mb-3">
                    <Globe className="w-6 h-6 text-emerald-500" />
                  </div>
                  <h4 className="font-bold text-green-950 text-sm">{name}</h4>
