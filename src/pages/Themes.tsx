        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            {themes.map(({ icon: Icon, num, title, color, desc, subtopics }) => (
              <div key={num} className="group rounded-2xl border border-slate-100 hover:border-emerald-200 hover:shadow-xl transition-all overflow-hidden">
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <span className="text-xs font-black font-mono text-emerald-400/50">{num}</span>
                        <h3 className="font-display font-bold text-green-950 text-xl">{title}</h3>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {subtopics.map((s) => (
                            <span key={s} className="px-3 py-1 bg-emerald-50 border border-emerald-100 rounded-full text-emerald-700 text-xs font-medium">
                              {s}
                            </span>
                          ))}
                        </div>
