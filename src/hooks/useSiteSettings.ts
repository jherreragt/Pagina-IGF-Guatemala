...
const DEFAULTS: SettingsMap = {
  ...
  hero_subtitle: 'El espacio nacional de diálogo multiactor sobre gobernanza de Internet, vinculado al Internet Governance Forum de las Naciones Unidas.',
  ...
  principles_title: 'Principios del IGF',
  principles_intro: 'Facilita un entendimiento común sobre el cómo maximizar las oportunidades de Internet, y de gestionar los riesgos y retos que implica.',
  ...
  event_datetime_iso: '2026-11-09T09:00:00',
  event_registration_open: 'true',
  event_sessions_open: 'true',
  about_title: '¿Qué es la Gobernanza de la Internet?',
  about_body: 'Se refiere a los procesos y normas que afectan la forma en que se gestiona Internet. El éxito histórico y futuro de Internet como plataforma abierta y confiable para la innovación y el empoderamiento depende de la adopción de un enfoque descentralizado, colaborativo y de múltiples partes interesadas.',
